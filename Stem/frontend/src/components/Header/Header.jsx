...
function Header({ darkMode, toggleDarkMode }) {
    ...
    return (
        <header className="sticky top-0 z-50 bg-white/80 dark:bg-gray-900/95 backdrop-blur-xl border-b border-slate-200/50 dark:border-gray-700/50 shadow-lg hidden sm:block">
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <Link to="/" className="group flex items-center gap-3 hover:scale-105 transition-transform duration-300">
                        <div className="relative">
                            <img src={logo} alt="Amjilt STEM" className="w-10 h-10 rounded-xl shadow-sm" />
                        ...
                        <span className="font-bold text-xl text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                            Amjilt STEM
                        </span>
                    </Link>
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        <Link to="/" className="relative group">
                            <span className="text-slate-700 dark:text-gray-300 font-semibold hover:text-blue-600 dark:hover:text-gray-200 transition-colors duration-300 px-3 py-2 rounded-lg hover:bg-blue-50 dark:hover:bg-gray-800/20">
                                Нүүр
                            </span>
                        ...
                        <Link to="/chemistry" className="relative group">
                            <span className="text-slate-700 dark:text-gray-300 font-semibold hover:text-blue-600 dark:hover:text-gray-200 transition-colors duration-300 px-3 py-2 rounded-lg hover:bg-blue-50 dark:hover:bg-gray-800/20">
                                Хими
                            </span>
                            <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-500 to-emerald-500 group-hover:w-full transition-all duration-300"></div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {isAuthenticated ? (
                            <div className="relative" ref={profileRef}>
                                <button
                                    ...
                                    className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-blue-50 dark:hover:bg-gray-800/20 transition-all duration-300 hover:scale-105"
                                >
                                ...
                                {/* Profile Dropdown */}
                                <div
                                    className={`absolute right-0 mt-2 w-48 bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-2xl shadow-xl backdrop-blur-xl z-20 overflow-hidden transition-all duration-300 ${isProfileOpen
                                ...
                                >
                                    <div className="py-2">
                                        ...
                                        <Link
                                            to="/dashboard"
                                            className="flex items-center px-4 py-2 text-sm text-slate-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-gray-800/20 transition-colors duration-200"
                            ...
                            <div className="flex items-center gap-2">
                                <Link
                                    to="/login"
                                    className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300"
                                >
                                    Нэвтрэх
                                </Link>
                                <Link
                        ...
                        <button
                            ...
                            className="relative w-14 h-7 flex items-center rounded-full p-1 bg-gradient-to-r from-slate-200 to-slate-300 dark:from-gray-700 dark:to-gray-800 shadow-inner transition-all duration-300 hover:shadow-lg"
                        >
                            <div
                                className={`w-5 h-5 rounded-full absolute transform transition-all duration-300 flex items-center justify-center shadow-lg ${darkMode
                                    ? 'translate-x-7 bg-gradient-to-br from-gray-800 to-black'
