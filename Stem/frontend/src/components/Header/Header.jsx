                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {isAuthenticated ? (
                            <div className="relative" ref={profileRef}>
                                ...
                                {/* Profile Dropdown */}
                                <div 
                                    className={`absolute right-0 mt-2 w-48 bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-2xl shadow-xl backdrop-blur-xl z-20 overflow-hidden transition-all duration-300 ${
                                        isProfileOpen 
                        ...
                        >
                            <div 
                                className={`w-5 h-5 rounded-full absolute transform transition-all duration-300 flex items-center justify-center shadow-lg ${
                                    darkMode 
