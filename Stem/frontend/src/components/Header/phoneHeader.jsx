                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {isAuthenticated ? (
                            <div className="relative" ref={profileRef}>
                                ...
                                {/* Profile Dropdown */}
                                <div 
                                    className={`absolute right-0 mt-2 w-40 bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-xl shadow-xl backdrop-blur-xl z-20 overflow-hidden transition-all duration-300 ${
                                        isProfileOpen 
                        ...
                        >
                            <div 
                                className={`w-4 h-4 rounded-full absolute transform transition-all duration-300 flex items-center justify-center shadow-lg ${
                                    darkMode 
