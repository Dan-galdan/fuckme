...
function PhoneFooter() {
    return (
        <footer className="w-full bg-gradient-to-b from-white to-slate-50 dark:from-gray-900 dark:to-black border-t border-slate-200 dark:border-gray-700 sm:hidden">
            <div className="px-4 py-8">
                ...
                <div className="text-center mb-6">
                    <Link to="/" className="group inline-flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h3 className="font-bold text-lg text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                                Amjilt STEM
                            </h3>
                ...
                <div className="space-y-3 mb-6">
                    <Link
                        to="/aboutUs"
                        className="block text-center text-slate-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 py-2"
                    >
                        Бидний тухай
                    </Link>
                    <Link
                ...
                <div className="text-center pt-4 border-t border-slate-200 dark:border-gray-700">
                    <div className="flex items-center justify-center gap-2 text-sm text-slate-500 dark:text-gray-400 mb-2">
                        <CopyrightIcon />
